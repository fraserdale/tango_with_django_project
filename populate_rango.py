...
def populate():
	...
	python_pages = [
		...
		'url':'http://docs.python.org/3/tutorial/','views':5}, {'title':'How to Think like a Computer Scientist',
		'url':'http://www.greenteapress.com/thinkpython/','views':4}, {'title':'Learn Python in 10 Minutes',
	...
	other_pages = [ {'title':'Bottle',
		'url':'http://bottlepy.org/docs/dev/','views':11}, {'title':'Flask',
